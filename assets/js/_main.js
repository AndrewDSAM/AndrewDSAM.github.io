...
/* ==========================================================================
   DESKTOP NAVIGATION — keep all navigation items visible
   ========================================================================== */
...
(function () {
  function fixDesktopNavigation() {
    ...
    /* Mantém todos os links principais visíveis */
    if (hiddenLinks) {
      var hiddenItems = hiddenLinks.querySelectorAll("li");
    ...
    /* Esconde o botão de overflow no desktop */
    if (button) {
      button.style.display = "none";
    }

    /* Mantém a lista visível */
    visibleLinks.style.display = "flex";
    visibleLinks.style.visibility = "visible";
    visibleLinks.style.opacity = "1";
  }

  document.addEventListener("DOMContentLoaded", fixDesktopNavigation);

  window.addEventListener("load", function () {
    setTimeout(fixDesktopNavigation, 100);
    setTimeout(fixDesktopNavigation, 500);
    setTimeout(fixDesktopNavigation, 1000);
  });

  window.addEventListener("resize", fixDesktopNavigation);
})();
